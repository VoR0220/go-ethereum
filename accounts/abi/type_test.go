...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"uint156", big.NewInt(1), ""},
		{"uint164", big.NewInt(1), ""},
		{"uint172", big.NewInt(1), ""},
		{"uint180", big.NewInt(1), ""},
		{"uint188", big.NewInt(1), ""},
		{"uint196", big.NewInt(1), ""},
		{"uint204", big.NewInt(1), ""},
		{"uint212", big.NewInt(1), ""},
		{"uint220", big.NewInt(1), ""},
		{"uint228", big.NewInt(1), ""},
		{"uint236", big.NewInt(1), ""},
		{"uint244", big.NewInt(1), ""},
		{"int24", big.NewInt(1), ""},
		{"int40", big.NewInt(1), ""},
		{"int48", big.NewInt(1), ""},
		{"int56", big.NewInt(1), ""},
